package com.teatroabc.constantes;
...
public class Constantes {
    ...
    // Preços
    public static final double PRECO_FRISAS = 25.00;
    public static final double PRECO_BALCAO_NOBRE = 20.00;
    public static final double PRECO_BALCAO = 15.00;
